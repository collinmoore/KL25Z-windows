...
{
	/* Write your code here ... */
	UART_Desc *ptr = (AS1_TDeviceData*)UserDataPtr;
...
void AS1_OnBlockSent(LDD_TUserData *UserDataPtr)
{
  /* Write your code here ... */
	UART_Desc *ptr = (AS1_TDeviceData*)UserDataPtr;
	ptr-> isSent = TRUE; // sets flag saying that we are done sending
}
...
{
	/* this timer controls the constant load circuit for the duty cycle load simulation 
	  *  GPIO pin D6 is the low-current (receive) load
